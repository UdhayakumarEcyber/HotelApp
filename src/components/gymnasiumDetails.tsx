...
const GymnasiumDetails: React.FunctionComponent<IWidgetProps> = (props) => { 
      ...
      <div  className="facility_details">   
            ...
            <div className="facility_widget-content"> 
                ...
                <div className="facility_pict">
                    <img src="https://static.iviva.com/images/Udhayimages/Hotel/gym-pict.jpg" />
                </div>
            </div>   
...
export default GymnasiumDetails;